package com.example.commonlibrary.view.swipemenu;
...
//                    L.e(TAG, "gap = " + gap);
    ...
    public void smoothClose() {
        startmoothClose(null);
    }


    public void smoothClose(ClosedListener listener) {
        startmoothClose(listener);
    }

    private void startmoothClose(ClosedListener listener) {
